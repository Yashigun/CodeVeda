  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        <NavLink to='/'>
          <li className='py-1 text-primary'>HOME</li>
          <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
        </NavLink>
        <NavLink to='/Doctors'>
          <li className='py-1 text-primary'>DOCTORS</li>
          <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
        </NavLink>
        <NavLink to='/About'>
          <li className='py-1 text-primary'>ABOUT</li>
          <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
        </NavLink>
        <NavLink to='/Contact'>
          <li className='py-1 text-primary'>CONTACT</li>
          <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden'/>
        </NavLink>
      </ul>
      <div className='flex items-center gap-4'>
        {
            ...
            ? <div className='flex items-center cursor-pointer group relative'>
                ...
                <div className='absolute top-0 right-0 pt-14 text-base font-small text-secondary z-20 hidden group-hover:block'>
                    <div className='min-w-48 bg-primary rounded flex flex-col gap-1.5'>
